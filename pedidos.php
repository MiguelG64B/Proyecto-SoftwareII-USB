...
left join usuario on ventas.id_usuario = usuario.id
...
<head>
  ...
  <title>Panel| Historial de ventas </title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Principal</a> <span class="mx-2 mb-0">/</span>
           ...
           <span class="mx-2 mb-0">/</span> <strong class="text-black">Historial de ventas</strong></div>
        </div>
      </div>
    </div>
  <div class="wrapper">
                ...
                <div class="card-header" id="heading<?php echo $f['id']; ?>">
                  <h5 class="mb-0">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse<?php echo $f['id']; ?>" aria-expanded="true" aria-controls="collapse<?php echo $f['id']; ?>">
                      <?php echo $f['fecha'] . '-' . $f['nombre'] . '-' . $f['Apellido']; ?>
                    </button>
                  </h5>
                </div>
                ...
                <div id="collapse<?php echo $f['id']; ?>" class="collapse" aria-labelledby="heading<?php echo $f['id']; ?>" data-parent="#accordionExample">
                  <div class="card-body">
                    ...
                    <form action="./php/estadoventa.php" method="post">
                      <p>Estado de venta: <b>  <select class="form-select" name="estadoventa" aria-label="Default select example">
                    ...
                    <p class="h6"> Datos del usuario</p>
                    <?php
                 ...
                 WHERE productos_venta.id_venta =" . $f['id'] ) or die($conexion->error);
                    ...
                    <input type="hidden" id="id_producto" name="id_producto" value=" <?php echo $f2['id_producto']; ?> " class="form-control">
                    <input type="hidden" id="cantidad" name="cantidad" value=" <?php echo $f2['cantidad']; ?> " class="form-control">
