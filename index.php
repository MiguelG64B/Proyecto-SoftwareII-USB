    ...
    <div class="site-section">
     ...
     <div class="col-md-3 order-1 mb-5 mb-md-0">
            <div class="border p-4 rounded mb-4">
              ...
              <div class="mb-4">
                <h3 class="mb-3 h6 text-uppercase text-black d-block">Precios</h3>
                <label for="s_lg" class="d-flex">
                  <input type="checkbox" id="s_lg" class="mr-2 mt-1"> <span class="text-black">$0 a $100</span>
                </label>
                <label for="s_lg" class="d-flex">
                  <input type="checkbox" id="s_lg" class="mr-2 mt-1"> <span class="text-black">$100 a $1,000</span>
                </label>
                <label for="s_lg" class="d-flex">
                  <input type="checkbox" id="s_lg" class="mr-2 mt-1"> <span class="text-black">$1,000 a $10,000</span>
                </label>
              </div>
              <button class="btn btn-outline-primary btn-sm btn-block">Filtrar</button>
            </div>
