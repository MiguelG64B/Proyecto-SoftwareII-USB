...
<div class="card" style="width: 40rem;">
  ...
  <form method="POST" action="mensajes.php">
    ...
    <textarea class="form-control" name="mensaje" placeholder="Ingresa un mensaje"></textarea>
    <input class="btn btn-primary editar" type="submit" name="enviar" value="Enviar">
  </form>
  </div>
</div>
  <?php
