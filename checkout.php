...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <form action="./volante.php" method="post">
              ...
              <label for="c_code" class="text-black mb-3">¿Quieres cambiar los datos de envio? 
                ...
                <div class="form-group row mb-5">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="direccion" value="<?php echo $arregloUsuario['direccion']; ?>" id="direccion" class="form-control" >
                  </div>
                  <div class="col-md-6">
                    <label for="c_email_address" class="text-black">Ciudad</span></label>
                    <input type="text" name="ciudad" value="<?php echo $arregloUsuario['ciudad']; ?>" id="ciudad"  class="form-control">
                  </div>
                  <div class="col-md-6">
                    <label for="c_email_address" class="text-black">Departamento</span></label>
                    <input type="text" name="estado" value="<?php echo $arregloUsuario['estado']; ?>" id="estado"  class="form-control">
                  </div>
                  <div class="col-md-6">
                    <label for="c_phone" class="text-black">Numero de celular</span></label>
                    <input type="text" name="telefono" value="<?php echo $arregloUsuario['telefono']; ?>" id="telefono"  class="form-control">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="p-3 p-lg-5 border">
                    ...
                    <div class="form-group">
                      <button class="btn btn-primary btn-lg py-3 btn-block" type="submit">Solicitar volante de pago</button>
                    </div>
                  </div>
                </div>
              </div>
