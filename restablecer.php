  ...
  <div class="site-wrap">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <form class=" container col-3" action="./php/restablecer.php" method="POST">
          <a>Ingresa tu correo
          </a>
          <div class=" mb-3">
            <input type="email" class="form-control" placeholder="Ingresa tu correo" id="c" name="email">

          </div>
          <button type="submit" class="btn btn-primary">Solicitar codigo</button>
        </form>
        <?php 
