...
<head>
  ...
  <title>Panel de administracion| categoria</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Principal</a> <span class="mx-2 mb-0">/</span>
            ...
            <span class="mx-2 mb-0">/</span> <strong class="text-black">Categorias</strong>
          </div>
        </div>
      </div>
    </div>
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                  <a href="./panel" class="d-block"><?php echo $arregloUsuario['nombre']; ?></a>
                </div>
              </div>
              <li class="nav-item">
          ...
          ?>
                ...
                ?>
                  <tr>
                    ...
                    <td> 
                    <input type="text" name="estadoventa" value="<?php echo $f['estadoventa']; ?>" id="estadoventa" >
                    <!-- esto era para elegir el estado de venta pero dio un fallo que ni idea perro
                  ...
                  <input type="hidden" id="id" name="id" value=" <?php $f['id']; ?> " class="form-control">
                <?php
                }
                ?>
            ...
            <button type="submit" href="./php/estadoventa.php" class="btn btn-primary editar">Guardar cambios</button>
          </div>
          </div>
        </section>
        </form>
