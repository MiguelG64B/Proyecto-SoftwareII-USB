      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Principal</a> <span class="mx-2 mb-0">/</span>
           <strong class="text-black">Carrito de compra</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row mb-5">
              ...
              <a href="carrito.php"> <button class="btn btn-primary btn-sm btn-block">Actualizar carrito</button></a>
              </div>
              <div class="col-md-6">
              <a href="index.php"><button  class="btn btn-outline-primary btn-sm btn-block"  href="index.php">Comprar mas</button> </a>
              </div>
            </div>
          </div>
          ...
          ?>
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='checkout.php'">Confirmar compra</button>
                  </div>
                </div>
              </div>
            </div>
